...
Проброс 80/443 на NPM — страница **NPM** в панели: один IP виртуалки,
роутер определяется сам. Пустое поле снимает проброс, маршрут и DNS alias.
На Keenetic: DNS клиентов = `10.10.10.1` и МЭ WAN→NPM 80/443.
